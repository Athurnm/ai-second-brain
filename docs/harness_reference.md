...
- **Proactive Assistant** -- [`.agent/skills/proactive-assistant/`](../.agent/skills/proactive-assistant/): the owner's autonomous Product Operations system syncing Dashboard, todo, master_followup_tracker; surfaces management mandates and team workload imbalances.
- **Project Tracking Update** -- [`.agent/skills/project-tracking-update/`](../.agent/skills/project-tracking-update/): Triple-Check protocol keeping Dashboard, todo.md, master_followup_tracker.md synchronized on task completion and overdue detection.
